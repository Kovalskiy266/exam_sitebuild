...
class __TwigTemplate_36857e0c0efcd879d4cab109fda02f366fa3ee3651bc1cbf041d780a5e8deb29 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 27
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_call_macro($macros["menus"], "macro_menu_links", [($context["items"] ?? null), ($context["attributes"] ?? null), 0], 27, $context, $this->getSourceContext())));
        echo "
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "toolbar-menu"], "method", false, false, true, 33), 33, $this->source), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/stable/templates/navigation/menu--toolbar.html.twig", "/var/www/web/core/themes/stable/templates/navigation/menu--toolbar.html.twig");
    }
