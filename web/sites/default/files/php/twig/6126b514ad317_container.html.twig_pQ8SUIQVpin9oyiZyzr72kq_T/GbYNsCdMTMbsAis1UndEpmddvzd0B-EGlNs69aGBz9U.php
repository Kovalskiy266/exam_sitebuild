...
class __TwigTemplate_3fa343078360bbe2b647fa375a349ebfdc22f6d57bc94ce0209dc20629fe9898 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["has_parent"] ?? null)) ? ("form-wrapper") : (""))];
        ...
        echo ">";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["children"] ?? null), 28, $this->source), "html", null, true));
        echo "</div>
";
    }
    ...
    {
        return new Source("", "core/themes/classy/templates/form/container.html.twig", "/var/www/web/core/themes/classy/templates/form/container.html.twig");
    }
