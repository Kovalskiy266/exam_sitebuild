...
class __TwigTemplate_dd2197e6b5dafdcc438787284f9d046d57b42abd99fb1725c3d7777862e47ab4 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "menu"], "method", false, false, true, 33), 33, $this->source), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-item--active-trail") : (""))];
        ...
        ";
                    // line 47
                    if ((twig_get_attribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, true, 47) == "Home")) {
                        // line 48
                        echo "          ";
                        $context["title"] = ('' === $tmp = "            <i class=\"fas fa-home\"></i>
          ") ? '' : new Markup($tmp, $this->env->getCharset());
                        // line 51
                        echo "          ";
                        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getLink($this->sandbox->ensureToStringAllowed(($context["title"] ?? null), 51, $this->source), $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 51), 51, $this->source)), "html", null, true));
                        echo "
        ";
                    } else {
                        // line 53
  ...
  ";
    ...
    {
        return array (  139 => 60,  132 => 58,  126 => 56,  123 => 55,  117 => 53,  111 => 51,  107 => 48,  105 => 47,  100 => 46,  98 => 43,  97 => 42,  96 => 41,  95 => 39,  93 => 38,  88 => 37,  84 => 35,  78 => 33,  75 => 32,  72 => 31,  69 => 30,  54 => 29,  49 => 63,  44 => 27,  41 => 22,  39 => 21,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/custom/exam/templates/menu--main.html.twig", "/var/www/web/themes/custom/exam/templates/menu--main.html.twig");
    }
