...
class __TwigTemplate_065e8ed6124687dd716e378d7c6d48e1aa9aff4b4d02a20d280c0b8090008c87 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["has_parent"] ?? null)) ? ("form-wrapper") : (""))];
        ...
        if ( !($context["closed"] ?? null)) {
            ...
            echo ">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["message"] ?? null), 26, $this->source), "html", null, true));
            echo "</div>
";
        }
    }
